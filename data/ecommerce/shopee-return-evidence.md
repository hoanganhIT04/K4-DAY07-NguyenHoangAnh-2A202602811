---
doc_id: "shopee-return-evidence"
title: "Hướng dẫn chuẩn bị bằng chứng trả hàng hoàn tiền"
...
Quét mã QR/ Kiểm tra số seri

Quay video quét mã QR, kiểm tra số seri trên trang web của hãng để chứng minh sản phẩm không phải hàng thật.

So sánh sản phẩm

Chụp ảnh/quay video so sánh sự khác biệt giữa sản phẩm thực nhận và sản phẩm chính hãng (màu sắc, chất liệu, tem nhãn, logo, mã sản phẩm).
